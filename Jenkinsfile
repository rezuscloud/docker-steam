pipeline {
  ...
  environment {
    ...
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-steam'
    CONTAINER_NAME = 'steam'
    DOCKERHUB_IMAGE = 'linuxserver/steam'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/steam'
    PR_DOCKERHUB_IMAGE = 'lspipepr/steam'
    DIST_IMAGE = 'debian'
    MULTIARCH = 'false'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-steam/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-steam\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-steam\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Steam\" \
          --label \"org.opencontainers.image.description=[Steam](https://store.steampowered.com/) is the ultimate destination for playing, discussing, and creating games.\" \
